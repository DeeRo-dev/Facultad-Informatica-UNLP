...
El programa lo que hace es imprimir un numero aleatorio.
...
program incispE;
procedure imprimirValores(n, a ,b:integer);
var
    i, ale: integer;
begin
    for i := 1 to n do 
    begin
       ale := random(b - a - 1) + a + 1;
        writeln('Valor ', i ,' : ' , ale);   
    end;
end;
var 
    ...
    i, n, a, b: integer;
begin
    writeln ('Ingrese un rango entre A y B: ');
    write('Rango A: ');
    readln(a);
    write('Rango B: ');
    readln(b);
    while(b < a) do
    begin
        write('El rango para B debe ser mayor que ', a,': ');
        readln(b);
    end;
    write('Ingrese un numero para que se repitan N: ');
    readln(n);
    imprimirValores(n, a, b)
end.
...
program incispF;
procedure imprimirValores(f, a ,b:integer);
var
     ale, i: integer;
begin
    i := 1;
    ...
    writeln;
    writeln('---  Fin del programa el valor de random ( ', ale , ' ) es = a: ', f, '  ----');
end;
var 
    ale: integer;
    i, f, a, b: integer;
